  ...
  return (
    <div className="max-w-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
        ...
        <div>
          <label className="block font-semibold mb-1">Week</label>
          <input {...register('Week', { required: true })} placeholder="e.g. Week 10" className="w-full border rounded-lg px-4 py-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/30" />
        </div>
        <div>

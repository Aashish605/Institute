        ...
        <div>
            <div className=" flex p-8 justify-center ">
                <div className="bg-white w-full max-w-md">
                    ...
                    <a href="http://localhost:4000/auth/google" className=' flex mx-auto items-center justify-center border w-fit px-9 py-3 gap-4 rounded-xl border-gray-200 bg-gray-50'>

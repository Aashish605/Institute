...
const About = () => {
    ...
    return (
        <div className="max-w-[85vw] mx-auto">
            <div className='bg-[url(/About/image.png)] overflow-hidden my-12 w-full h-[35vh] max-sm:h-[35vh] bg-center bg-cover rounded-2xl text-white relative'>
                <div className='absolute inset-0' style={{ background: 'rgba(0,0,0,0.3)' }} />
                <div className='relative z-10 flex flex-col justify-center h-full px-16 max-sm:px-3'>
                    <TextGenerateEffect
                        words={content.about_hero_title || 'About Mirror'}
                        className="!mt-0"
                        duration={0.3}
                    />
                    <p className='text-xl mt-2'>{content.about_hero_subtitle || 'Building a strong foundation for your future'}</p>
                </div>
            </div>
            ...
            <div className="bg-gray-50 w-full">
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-8 mx-6 pb-12">
                        {[
                            { icon: "About/expert.png", title: "Expert Instructors", desc: "Our team consists of efficient and knowledgeable instructors with extensive experience in competitive exam preparation." },
                            { icon: "About/learning.png", title: "Flexible Learning", desc: "Students can practice anytime and anywhere through online exams and get results that enhance their abilities." },
                            { icon: "About/support.png", title: "Dedicated Support", desc: "Regular Q&A, doubt clearing sessions, and special guidance by IOE Ambassadors every week." },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                                ...
                                className='bg-white shadow-md rounded-xl px-2 py-6 transition-all duration-300'
                            >
                                <div className="w-16 h-16 rounded-full mb-2 mx-auto flex items-center justify-center">
                                    <img src={item.icon} alt={item.title} className='w-[7vh] object-center object-cover' loading="lazy" />
                                </div>
                                <h3 className="font-bold mb-2 text-center text-xl">{item.title}</h3>
                                <p className="text-left opacity-70 px-4">{item.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                    <motion.p
                        ...
                        viewport={{ once: true }}
                        className='max-w-[65vw] mx-auto text-center text-xl opacity-70 py-7'
                    >
                        Founded by Pulchowk Campus graduates and front-line faculty members, Mirror contributes towards the development of qualitative future engineers who tend to establish a well-settled destiny in the field of engineering.
                    </motion.p>
                </section>
            </div>
            ...
            <section className="mb-12 h-fit rounded-2xl shadow-md overflow-hidden flex items-center bg-secondary max-[1130px]:bg-white justify-center gap-7 max-[1130px]:flex-col">
                <div className='flex flex-col items-center justify-center py-6 bg-secondary max-[1130px]:w-full w-1/3 h-full'>
                    <img src="About/person.png" alt="Mirror Family" loading="lazy" />
                ...
                <div className='w-2/3 max-[1130px]:w-full max-[1130px]:px-4 max-[1130px]:py-6 py-12 px-6 bg-white'>
                    ...
                    <p className="mb-4">
                        Finally, we believe Mirror shall be considered as a place where your talent is furnished and you shall prepare yourself for a rewarding career in your interested field of engineering/IT and eventually to be a morally honoured and cultured citizen.
                    </p>
                    <p>
